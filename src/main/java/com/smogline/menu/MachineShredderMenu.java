...
import com.smogline.api.energy.ILongEnergyMenu;
import com.smogline.block.ModBlocks;
import com.smogline.block.entity.custom.machines.MachineShredderBlockEntity;
import com.smogline.network.ModPacketHandler;
import com.smogline.network.packet.PacketSyncEnergy;
    ...
    public void broadcastChanges() {
        ...
        if (blockEntity != null && blockEntity.getLevel() != null && !blockEntity.getLevel().isClientSide) {
            ModPacketHandler.INSTANCE.send(
                    ...
                    new com.smogline.network.packet.PacketSyncEnergy(
                            this.containerId,
