package com.smogline.block.entity.custom.machines;
...
import com.smogline.block.custom.machines.MachineAdvancedAssemblerBlock;
// import com.smogline.client.ClientSoundManager;
...
import com.smogline.menu.MachineAdvancedAssemblerMenu;
import com.smogline.module.machine.MachineModuleAdvancedAssembler;
import com.smogline.multiblock.IFrameSupportable;
...
import com.smogline.util.LongDataPacker;
...
public class MachineAdvancedAssemblerBlockEntity extends BaseMachineBlockEntity implements IFrameSupportable {
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.smogline.advanced_assembly_machine");
    }
    ...
    //             () -> new com.smogline.sound.AdvancedAssemblerSoundInstance(this.getBlockPos()));
    ...
    public static class ClientTicker {
        ...
        private boolean wasCraftingLastTick = false;
        private com.smogline.sound.AdvancedAssemblerSoundInstance soundInstance;
        ...
        private void updateSound(MachineAdvancedAssemblerBlockEntity entity) {
            ...
            if (isCrafting && (this.soundInstance == null || this.soundInstance.isStopped())) {
                this.soundInstance = new com.smogline.sound.AdvancedAssemblerSoundInstance(entity.getBlockPos());
        ...
        if (level != null && !level.isClientSide) {
            ...
            if (getBlockState().getBlock() instanceof MachineAdvancedAssemblerBlock block) {
                ...
                for (BlockPos localPos : helper.getStructureMap().keySet()) {
                    ...
                    if (block.getPartRole(localPos) == com.smogline.multiblock.PartRole.ENERGY_CONNECTOR) {
