...
public class ArmorTooltipHandler {
    ...
    public static Optional<Component> getRadResistanceTooltip(ItemStack stack) {
        ...
        if (absoluteProtection > 0) {
            Component tooltipLine = Component.translatable("tooltip.smogline.rad_protection.value",
    ...
    public static Optional<List<Component>> getModificationsTooltip(ItemStack stack, boolean isAlwaysVisible) {
        ...
        if (!isAlwaysVisible && !Screen.hasShiftDown()) {
            return Optional.of(List.of(Component.translatable("tooltip.smogline.hold_shift_for_details").withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC)));
        }
        ...
        if (!modsTooltipLines.isEmpty()) {
            ...
            result.add(Component.translatable("tooltip.smogline.mods").withStyle(ChatFormatting.GOLD));
