package com.smogline.block.custom.machines.armormod.menu;
...
public class ArmorTableMenu extends AbstractContainerMenu {
    ...
    private class CentralArmorSlot extends SlotItemHandler implements IHasTooltip {
        ...
        public Component getEmptyTooltip() {
            return Component.translatable("tooltip.smogline.armor_table.main_slot").withStyle(ChatFormatting.YELLOW);
        }
    ...
    private class ModificationSlot extends SlotItemHandler implements IHasTooltip {
        ...
        private static final Map<Integer, String> TOOLTIP_KEYS = Map.of(
            0, "tooltip.smogline.armor_table.helmet_slot",
            1, "tooltip.smogline.armor_table.chestplate_slot",
            2, "tooltip.smogline.armor_table.leggings_slot",
            3, "tooltip.smogline.armor_table.boots_slot",
            4, "tooltip.smogline.armor_table.battery_slot",
            5, "tooltip.smogline.armor_table.special_slot",
            6, "tooltip.smogline.armor_table.plating_slot",
            7, "tooltip.smogline.armor_table.casing_slot",
            8, "tooltip.smogline.armor_table.servos_slot"
        );
