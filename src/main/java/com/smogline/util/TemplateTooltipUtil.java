...
public class TemplateTooltipUtil {
    ...
    public static void buildTemplateTooltip(ItemStack stack, Level level, List<Component> tooltip) {
        ...
        if (output.isEmpty()) {
            tooltip.add(Component.translatable("tooltip.smogline.template_broken").withStyle(ChatFormatting.RED));
            return;
        }
        ...
        tooltip.add(Component.translatable("tooltip.smogline.created_with_template_folder").withStyle(ChatFormatting.YELLOW));
    ...
    private static void addRecipeDetails(AssemblerRecipe recipe, ItemStack output, List<Component> tooltip) {
        // Выход
        tooltip.add(Component.translatable("tooltip.smogline.output").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
        tooltip.add(Component.literal("  " + output.getCount() + "x ").withStyle(ChatFormatting.WHITE)
                .append(output.getHoverName()));
        
        // Вход
        tooltip.add(Component.translatable("tooltip.smogline.input").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
        ...
        // Время производства
        tooltip.add(Component.translatable("tooltip.smogline.production_time").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
        ...
        tooltip.add(Component.literal("  " + formattedTime + " ")
                ...
                .append(Component.translatable("tooltip.smogline.seconds")));
        
        // НОВОЕ: Потребление энергии
        tooltip.add(Component.translatable("tooltip.smogline.energy_consumption").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
