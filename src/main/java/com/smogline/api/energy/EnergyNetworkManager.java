package com.smogline.api.energy;
...
public class EnergyNetworkManager extends SavedData {
    ...
    private static final String DATA_NAME = "smoglineodernized_energy_networks";
    ...
    private void addNode(BlockPos pos, @Nullable EnergyNetwork networkToAvoid) {
        ...
        for (Direction dir : Direction.values()) {
            ...
            if (neighbor == null && level.isLoaded(neighborPos)) {
                ...
                if (be != null) {
                    boolean isEnergyBlock = be.getCapability(com.smogline.capability.ModCapabilities.HBM_ENERGY_PROVIDER).isPresent() ||
                            be.getCapability(com.smogline.capability.ModCapabilities.HBM_ENERGY_RECEIVER).isPresent() ||
                            be.getCapability(com.smogline.capability.ModCapabilities.HBM_ENERGY_CONNECTOR).isPresent();
