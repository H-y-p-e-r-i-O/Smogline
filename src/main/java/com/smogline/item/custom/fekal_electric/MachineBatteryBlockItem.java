package com.smogline.item.custom.fekal_electric;
...
public class MachineBatteryBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        ...
        pTooltip.add(Component.translatable("tooltip.smogline.machine_battery.capacity", maxPower).withStyle(ChatFormatting.GOLD));
        pTooltip.add(Component.translatable("tooltip.smogline.machine_battery.charge_speed", maxPower / 200).withStyle(ChatFormatting.GOLD));
        pTooltip.add(Component.translatable("tooltip.smogline.machine_battery.discharge_speed", maxPower / 600).withStyle(ChatFormatting.GOLD));
        ...
        if (pStack.hasTag()) {
            ...
            if (blockEntityTag != null) {
                ...
                if (energy > 0) {
                    pTooltip.add(Component.translatable("tooltip.smogline.machine_battery.stored", energy, maxPower).withStyle(ChatFormatting.YELLOW));
                }
            }
        }
