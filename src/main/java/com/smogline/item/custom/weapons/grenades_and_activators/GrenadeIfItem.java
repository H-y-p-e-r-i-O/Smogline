package com.smogline.item.custom.weapons.grenades_and_activators; // Замените на ваш пакет

import com.smogline.entity.weapons.grenades.GrenadeIfProjectileEntity;
...
public class GrenadeIfItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.smogline.grenade_if.common.line1")
        ...
        switch (grenadeType) {
            case GRENADE_IF_HE ->
                    key = "tooltip.smogline.grenade_if.he.line2";
            case GRENADE_IF_SLIME ->
                    key = "tooltip.smogline.grenade_if.slime.line2";
            case GRENADE_IF_FIRE ->
                    key = "tooltip.smogline.grenade_if.fire.line2";
            case GRENADE_IF ->
                    key = "tooltip.smogline.grenade_if.standard.line2";
            default ->
                    key = "tooltip.smogline.grenade_if.default.line2";
        }
