...
import com.smogline.entity.weapons.grenades.GrenadeNucProjectileEntity;
...
public class GrenadeNucItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, @Nullable List<Component> tooltip, TooltipFlag flag) {
        ...
        // 1. Тёмно-красный
        tooltip.add(Component.translatable("tooltip.smogline.grenade_nuc.line1")
                .withStyle(ChatFormatting.DARK_RED));

        // 2. Красный
        tooltip.add(Component.translatable("tooltip.smogline.grenade_nuc.line2")
                .withStyle(ChatFormatting.RED));

        // 3. Серый
        tooltip.add(Component.translatable("tooltip.smogline.grenade_nuc.line3")
