...
public class ItemBlueprintFolder extends Item {
    ...
    public Component getName(@Nonnull ItemStack stack) {
        ...
        if (!pool.isEmpty()) {
            ...
            return Component.translatable("item.smogline.blueprint_folder.named")
                    .append(": ")
                    .append(pool);
        }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable Level level,
        ...
        if (pool.isEmpty()) {
            tooltip.add(Component.translatable("item.smogline.blueprint_folder.empty")
                .withStyle(ChatFormatting.GRAY));
            return;
        }
        
        tooltip.add(Component.translatable("item.smogline.blueprint_folder.desc")
            .withStyle(ChatFormatting.GRAY));
        ...
        if (level != null && level.getRecipeManager() != null) {
            ...
            if (recipes.isEmpty()) {
                ...
                tooltip.add(Component.translatable("item.smogline.blueprint_folder.obsolete")
            ...
            tooltip.add(Component.empty());
            tooltip.add(Component.translatable("item.smogline.blueprint_folder.recipes")
