...
import com.smogline.client.render.OcclusionCullingHelper;
    ...
    public static void onItemTooltip(ItemTooltipEvent event) {
        ...
        if (hasTags) {
            if (Screen.hasShiftDown()) {
                ...
                event.getToolTip().add(Component.translatable("tooltip.smogline.tags").withStyle(ChatFormatting.GRAY));
                ...
                event.getToolTip().add(
                    Component.translatable("tooltip.smogline.hold_shift_for_details")
