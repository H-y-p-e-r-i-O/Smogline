...
import com.smogline.block.entity.custom.machines.MachineAdvancedAssemblerBlockEntity;
import com.smogline.block.entity.custom.machines.MachineAdvancedAssemblerBlockEntity.ClientTicker;
import com.smogline.block.custom.machines.MachineAdvancedAssemblerBlock;
import com.smogline.client.model.MachineAdvancedAssemblerBakedModel;
import com.smogline.client.render.shader.ImmediateFallbackRenderer;
import com.smogline.client.render.shader.RenderPathManager;
...
public class MachineAdvancedAssemblerRenderer extends AbstractPartBasedRenderer<MachineAdvancedAssemblerBlockEntity, MachineAdvancedAssemblerBakedModel> {
    ...
    private void renderRecipeIconDirect(MachineAdvancedAssemblerBlockEntity be,
        ...
        var recipe = be.getLevel() == null ? null : be.getLevel().getRecipeManager()
                ...
                .filter(r -> r instanceof com.smogline.recipe.AssemblerRecipe)
                .map(r -> (com.smogline.recipe.AssemblerRecipe) r)
                .orElse(null);
