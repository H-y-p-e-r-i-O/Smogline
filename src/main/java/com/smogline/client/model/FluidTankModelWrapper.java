package com.smogline.client.model;

import com.smogline.block.entity.custom.machines.MachineFluidTankBlockEntity;
...
public class FluidTankModelWrapper extends BakedModelWrapper<BakedModel> {
    ...
    public FluidTankModelWrapper(BakedModel original) {
        ...
        // Убедись, что путь совпадает с тем, что в .mtl: map_Kd smogline:block/tank/tank_none
        this.targetSprite = Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS)
                .apply(new ResourceLocation("smogline", "block/tank/tank_none"));
    }
